    ...
    <section id="about" className="bg-white py-14 md:py-20">
      <div className="max-w-3xl mx-auto px-6 md:px-8 text-center">
        <p className="text-lg md:text-2xl font-semibold text-ink-800 leading-relaxed">
          LTL TV est une chaîne chrétienne focalisée à annoncer
          l'Évangile par les médias.
        </p>
        <p className="mt-8 text-base md:text-lg text-ink-500 leading-relaxed">
          Nous offrons des émissions chaque semaine et des programmes LIVE
          Zoom et YouTube.{' '}
          <Link href="#emissions" className="text-brand-500 font-semibold hover:text-brand-600 underline underline-offset-4 decoration-brand-500/40">
            Plus
          </Link>
        </p>
